...
const { Purpose, Party,Property } = useSelector((state) => state);
  ...
  const handlePrint = () => {
    ...
    data.length
      ? PrintReport({ data, filters, title: "Tenants" })
  ...
  return (
    <>
      <div className="row align-items-center">
        <div className="col-9">
          <Breadcrumbs
            breadCrumbTitle="Tenants"
            breadCrumbParent="Reports"
            breadCrumbActive="Tenants"
          />
        </div>
          ...
          <Row>
            ...
            <Col sm="4">
              ...
              <CustomSelectV2
                ...
                options={Property}
                onChange={(e) =>
                  handleFiltersChange("Property", e?.value ?? null)
                }
              />
            </Col>
          </Row>
