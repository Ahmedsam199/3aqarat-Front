...
const Index = () => {
  ...
  const handlePrint = () => {
    ...
    data.length
      ? PrintReport({ data, filters, title: "collection Insurance" })
  ...
  const handleExcel = () => {
    ...
    data.length
      ? exportToExcel({
          ...
          fileName: "collection Insurance",
          SheetNames: ["collection Insurance"],
          isMutlSheets: false,
          isTwoTable: true,
        })
      : toasty({ type: "warning", msg: "data empty" });
  ...
  return (
    <>
      <div className="row align-items-center">
        <div className="col-9">
          <Breadcrumbs
            breadCrumbTitle="collection Insurance"
            breadCrumbParent="Reports"
            breadCrumbActive="collection Insurance"
          />
        </div>
      ...
      <Card>
        ...
        <Row>
          <Col sm="12">
            <CustomTableV2
              ref={ref}
              url={Routes.Report.collectionInsurance}
              filters={filters}
