...
export const deleteAttachments2 = (Series) => {
  return async (dispatch) => {
    try {
      dispatch({
        type: Types.Attachments2.delete,
        payload: Series,
      });
...
export const addAttachments2 = (attachment) => {
  return async (dispatch) => {
    try {
      dispatch({
        type: Types.Attachments2.add,
        payload: attachment,
      });
    } catch (e) {
      console.error("Joseph error", e);
...
export const clearAttachments2 = () => {
  return async (dispatch) => {
    try {
      dispatch({
        type: Types.Attachments2.clear,
      });
    } catch (e) {
      console.error("Joseph error", e);
    }
...
export const setAttachments2 = (attachments2) => {
  return async (dispatch) => {
    try {
      dispatch({
        type: Types.Attachments2.set,
        payload: attachments2,
      });
    } catch (e) {
      console.error("Joseph error", e);
    }
...
export const replaceSignleAttachment2 = (newFile) => {
...
export const renameSignleAttachment2 = ({ attachmentNames, acceptedFile }) => {
  return async (dispatch) => {
...
export const replaceMultipleAttachments2 = ({ duplicateNames, newFiles }) => {
  return async (dispatch, getState) => {
    let { Attachment } = getState();
...
export const renameMultipleAttachments2 = ({
  attachmentNames,
  acceptedFiles,
}) => {
  return async (dispatch, getState) => {
