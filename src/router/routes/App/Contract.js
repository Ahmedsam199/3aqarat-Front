...
const ContractPOST2 = lazy(() =>
  import("../../../views/App/contract/contracts/post2")
);
...
export default [
  ...
  {
    element: <ContractPOST />,
    path: "/Contract/CreateContract/:test",
    meta: {
      action: "read",
      resource: "DT-2",
    },
  ...
  {
    element: <ContractPOST2 />,
    path: "/Contract/NewContract/:series",
    meta: {
      action: "read",
      resource: "DT-6",
    },
